> **timer** **file** **descriptor** **HOWTO** ***Release*** ***3.13.3***
>
...
*\#* *Create* *an* *epoll* *object* ep = select.epoll()
...
*1st* *timer* *fires* *every* *0.25* *seconds* *in* *0.25* *seconds.*
*(0.25,* *0.5,* *0.75,*␣
...
> connection *{*fd*}*") ep.unregister(conn)
>
