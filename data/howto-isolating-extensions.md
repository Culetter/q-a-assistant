> **Isolating** **Extension** **Modules** ***Release*** ***3.13.3***
>
...
**CPython** **implementation** **detail:** Sharing truly immutable
...
my_struct \*state = (my_struct\*)PyType_GetModuleState(type); **if**
(state == NULL) {
